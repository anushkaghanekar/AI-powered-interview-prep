...
const LandingPage = () => {
  ...
  return (
    <>
      <div className='w-full min-h-full bg-[#ddcc98]'>
        <div className='w-[500px] h-[500px] bg-[#e9dba2] blur-[300px] absolute top-0 left-0'/>
        ...
        <div className='w-9/10 container mx-auto px-4 pt-6 pb-[200px] relative z-10'>
          ...
          <header className='flex justify-between items-center mb-16'>
            ...
            {user ? (
              ...
              <button className='bg-red-900 bg-opacity-40 text-sm font-semibold text-white px-7 py-2.5 rounded-full hover:bg-opacity-90 border border-white border-opacity-40 transition-colors cursor-pointer' onClick={() => setOpenAuthModal(true)}>
                Login / Sign Up
              </button>
            )}
          </header>
          ...
          <div className='flex flex-col md:flex-row items-center'>
            <div className='w-full md:w-1/2 pr-4 mb-8 md:mb-0'>
              ...
              <h1 className='text-5xl text-black font-medium mb-6 leading-tight'>
                ...
                <span className='text-transparent bg-clip-text bg-[radial-gradient(circle,_brown_0%,_red_100%)] bg-[length:200%_200%] animate-text-shine font-semibold'>
                  AI-Powered
                </span>{" "}
                Learning
              </h1>
            ...
            <div className='w-full md:w-1/2'>
              ...
              <button className='bg-black text-sm font-semibold text-white px-7 py-2.5 rounded-full hover:bg-yellow-100 hover:text-black border border-yellow-40 hover:border-yellow-300 transition-colors cursor-pointer' onClick={handleCTA}>
                Get Started
              </button>
            </div>
          </div>
